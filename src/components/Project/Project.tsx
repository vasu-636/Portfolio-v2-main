          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/vasu-636/FinalProject" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
                A full-stack Expense Tracker web application built with React and Firebase, featuring secure user authentication (including Google Sign-In) and real-time data storage. The app enables users to efficiently manage, update, and track their expenses with a responsive and user-friendly interface.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/vasu-636/JS-Add-To-Cart" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p> Developed a dynamic e-commerce web application using JavaScript, featuring product search, fully dynamic item rendering (no hardcoded data), and cart management using LocalStorage. The application provides a responsive and interactive user experience with persistent cart functionality. </p>
            </div>
            <footer> <ul className="tech-list"> <li>JavaScript</li> <li>LocalStorage</li> <li>HTML/CSS</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/vasu-636/DOOB-Project" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
              </div>
            </header>
            <div className="body">
              <h3>DOOB Project</h3>
              <p>
                Built a fully responsive website by cloning a modern template using HTML, CSS, and JavaScript, incorporating smooth animations and interactive UI elements to replicate a real-world design with high visual accuracy.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/vasu-636/ReactBootstrap" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                {/* <a href="https://react-bootstrap-blue.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> */}
              </div>
            </header>
            <div className="body">
              <h3>Invent</h3>
              <p>Developed a modern responsive website by cloning a template using React.js and Bootstrap, featuring component-based architecture and interactive hover animations to enhance user experience and visual appeal.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Developed a modern Employee Management System using React.js with Tailwind CSS and Flowbite components, featuring a clean and responsive UI. The application allows users to add, manage, and organize employee records with functionalities like department-based filtering, salary sorting, and dynamic data handling, providing an efficient and user-friendly management experience.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>ReactJs</li>
